...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_8_Pin|LED_1_Pin|LED_2_Pin|LED_3_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_LAT_GPIO_Port, LED_LAT_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : LED_8_Pin LED_1_Pin LED_2_Pin LED_3_Pin */
  GPIO_InitStruct.Pin = LED_8_Pin|LED_1_Pin|LED_2_Pin|LED_3_Pin;
  ...
  /*Configure GPIO pin : LED_LAT_Pin */
